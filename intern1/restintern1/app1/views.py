...
from app1.serializers import Userserializers,ChangePasswordSerializer,MyTokenObtainPairSerializer,UpdateSalarySerializer
    ...
    def post(self, request):
        if request.method == 'POST':
            ...
            if serializer.is_valid():
                ...
                user.salary=Decimal(str(salary))
                user.save()
