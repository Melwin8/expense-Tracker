...
urlpatterns = [
    ...
    path('update_salary/',views.UpdateSalary.as_view(), name='update_salary'),
    ...
    path('total-amount-by-category/', dviews.TotalAmountByCategoryInPercentageView.as_view()),
    path('expensebycategory/', dviews.TotalAmountByCategoryinmonth.as_view()),
